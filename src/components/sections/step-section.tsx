const LearningStep = ({ number, title, description }: { number: string, title: string, description: string }) => (
    <div className="group relative flex gap-6 pb-12 last:pb-0">
        ...
        <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-primary/30 bg-card backdrop-blur-xl text-xl font-bold text-primary shadow-[0_0_20px_rgba(153,27,27,0.3)] transition-all group-hover:scale-110 group-hover:border-primary group-hover:shadow-[0_0_25px_rgba(234,179,8,0.2)]">
            {number}
        </div>
...
const AlurSection = () => {
    return (
        <section id="step-section" className="py-24 px-6 flex flex-col w-full max-w-4xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                    Alur Belajar di <span className="text-primary">Lampion</span>
                </h2>
